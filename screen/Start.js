  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ position: "absolute", top: 60, left: 15 }}>
        <Image
          source={require("../assets/Screenshot_2023-11-04_171510-removebg-preview.png")}
      ...
      <View style={{ margin: 35 }}>
        ...
        >
          {" "}
          Yoga is the journey, not <br /> the destination
        </Text>
      </View>
      <View>
        <Text
        ...
        >
          Every day is a good day for <br /> Yoga
        </Text>
      </View>
      ...
      >
        <TouchableOpacity
          onPress={() => {
            navigation.navigate("Home", textI);
          }}
          style={{
